...
def build_status_payload(
    *,
    ...
    auto_block_attempted: int = 0,
    auto_block_success_count: int = 0,
    auto_block_failed_count: int = 0,
    auto_blocked_ips: List[str] | None = None,
    auto_block_behavior_types: List[str] | None = None,
    enforcement_mode: str = "",
    enforcement_success_count: int = 0,
    verification_success_count: int = 0,
    truly_blocked_count: int = 0,
    top_auto_block_behavior_type: str = "",
) -> Dict[str, Any]:
    """
    ...
    return {
        ...
        "auto_block_attempted": auto_block_attempted,
        "auto_block_success_count": auto_block_success_count,
        "auto_block_failed_count": auto_block_failed_count,
        "auto_blocked_ips": auto_blocked_ips or [],
        "auto_block_behavior_types": auto_block_behavior_types or [],
        ...
        "top_auto_block_behavior_type": top_auto_block_behavior_type,
...
def process_file(file_path: Path, dry_run: bool, env_mapping: Dict[str, str]) -> None:
    ...
    behavior_driven_summary = {
        ...
        "truly_blocked_count": 0,
        "top_auto_block_behavior_type": "",
    }
    ...
    try:
        ...
        write_status_json(
            ...
            build_status_payload(
                ...
                blocked_behavior_count=behavior_driven_summary["blocked_behavior_count"],
                top_blockable_behavior_type=behavior_driven_summary["top_blockable_behavior_type"],
                auto_block_enabled=behavior_driven_summary["auto_block_enabled"],
                auto_block_attempted=behavior_driven_summary["auto_block_attempted"],
                auto_block_success_count=behavior_driven_summary["auto_block_success_count"],
                auto_block_failed_count=behavior_driven_summary["auto_block_failed_count"],
                auto_blocked_ips=behavior_driven_summary["auto_blocked_ips"],
                auto_block_behavior_types=behavior_driven_summary["auto_block_behavior_types"],
                enforcement_mode=behavior_driven_summary["enforcement_mode"],
                enforcement_success_count=behavior_driven_summary["enforcement_success_count"],
                verification_success_count=behavior_driven_summary["verification_success_count"],
                truly_blocked_count=behavior_driven_summary["truly_blocked_count"],
                top_auto_block_behavior_type=behavior_driven_summary["top_auto_block_behavior_type"],
            ),
        )
        print(f"[log_watcher] 处理失败，已移动到失败目录：{failed_file_path}")
        print(f"[log_watcher] 失败原因文件：{reason_file_path}")
